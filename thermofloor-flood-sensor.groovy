/**
 *  Heatit Z-Relay - Thermofloor Flood sensor
 *
 ...
 */
metadata {
    definition(name: "Thermofloor Flood Sensor", namespace: "jc", author: "Jeremy Cook") {
...
def zwaveEvent(physicalgraph.zwave.commands.sensormultilevelv5.SensorMultilevelReport cmd) {
    log.debug "SensorMultilevelReport from FLOOD sensor ${cmd}"
